...
public class CO2_EmissionCalculatorTest {
    ...
    public void simpleTestsPerCategory() {
        ...
        assertEquals(defaultMediumCars, calculateCO2PerCategory(1, "km", 1, Medium_car));
    }

    @Test
    public void testDistanceDefaultValues() {
        //Small_cars
        assertEquals(142, calculateCO2(1000, "m", 1, "small-diesel-car"));
        assertEquals(154, calculateCO2(1000, "m", 1, "small-petrol-car"));
        assertEquals(73, calculateCO2(1000, "m", 1, "small-plugin-hybrid-car"));
        assertEquals(50, calculateCO2(1000, "m", 1, "small-electric-car"));

        //Medium_cars
        assertEquals(171, calculateCO2(1000, "m", 1, "medium-diesel-car"));
        assertEquals(192, calculateCO2(1000, "m", 1, "medium-petrol-car"));
        assertEquals(110, calculateCO2(1000, "m", 1, "medium-plugin-hybrid-car"));
        assertEquals(58, calculateCO2(1000, "m", 1, "medium-electric-car"));

        //Large_cars
        assertEquals(209, calculateCO2(1000, "m", 1, "large-diesel-car"));
        assertEquals(282, calculateCO2(1000, "m", 1, "large-petrol-car"));
        assertEquals(126, calculateCO2(1000, "m", 1, "large-plugin-hybrid-car"));
        assertEquals(73, calculateCO2(1000, "m", 1, "large-electric-car"));


        //Train
        assertEquals(6, calculateCO2(1000, "m", 1, "train"));
        assertEquals(calculateCO2(1, "km", 1, "train"),
                calculateCO2(1000, "m", 1, "train"));

        //Bus
        assertEquals(27, calculateCO2(1000, "m", 1, "bus"));
        assertTrue(calculateCO2(1, "km", 1, "bus") ==
                calculateCO2(1000, "m", 1, "bus"));
    }
}